...
// Corrected import to use the domain repository interface
...
class TaskViewModel(
    // Now using the domain repository interface
    ...
    fun fetchWeather(latitude: Double, longitude: Double) {
        viewModelScope.launch {
            ...
            getWeatherUseCase(latitude, longitude)
                ...
                .onFailure { error ->
                    _weatherState.value = WeatherUiState.Error(error.message ?: "Error al obtener el tiempo")
                }
        }
    }
